...
from orchestrator.aggregator import AggregationStrategy, create_aggregator
...
class PhaseRunner:
    ...
    async def run_until_complete(
        ...
        while True:
            ...
            if result.is_success:
                ...
                phase_state = self._state_machine.state.phases.get(next_phase_name)
                if phase_state:
                    from orchestrator.state_machine import PhaseStatus as SMPhaseStatus
                    phase_state.status = SMPhaseStatus.PENDING
    ...
    def _get_swarm_configs(
        ...
        if phase_name == "ideation":
            ...
            return create_ideation_swarm_configs(idea)
...
def create_default_runner(
    ...
    swarm_controller = SwarmController(max_concurrent=3)
